...
export default StyleSheet.create({
  ...
  dayCard: { width: 56, height: 76, backgroundColor: COLORS.border || '#F0F2F5', borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginRight: 10, shadowColor: '#000', shadowOpacity: 0.02, shadowRadius: 5, elevation: 1 },
  ...
  dayText: { fontSize: 21, color: COLORS.text || '#2C3E50', fontWeight: 'bold' },
  textActive: { color: COLORS.white },
  fullCalendarBtn: { width: 56, height: 76, backgroundColor: COLORS.white, borderWidth: 1, borderColor: COLORS.primary, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginRight: SIZES.padding },
